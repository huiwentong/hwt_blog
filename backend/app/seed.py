...
tools_data = [
    ToolItem(name="Mark2HTML", description="Markdown 一键转换为美观的 HTML 文档。", url="https://github.com/hwt/mark2html", icon="📝", category="utility"),
    ToolItem(name="CodeSnap", description="漂亮的代码截图工具，支持多种主题。", url="https://github.com/hwt/codesnap", icon="📸", category="developer"),
    ToolItem(name="IPalette", description="智能配色方案生成器。", url="https://github.com/hwt/ipalette", icon="🎨", category="design"),
    ToolItem(name="LogTail", description="轻量级日志查看器，支持实时 tail 和过滤。", url="https://github.com/hwt/logtail", icon="📋", category="developer"),
    ToolItem(name="TinyDB", description="嵌入式 JSON 文档数据库，纯 Python 实现。", url="https://github.com/hwt/tinydb", icon="🗄️", category="database"),
    ToolItem(name="FastProxy", description="高性能 HTTP/HTTPS 代理工具。", url="https://github.com/hwt/fastproxy", icon="🌐", category="network"),
]
